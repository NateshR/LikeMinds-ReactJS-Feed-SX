      ...
      <div className="lmWrapper__feed__post">
        ...
        <div className="lmWrapper__feed__post__body">
          <div className="lmWrapper__feed__post__body--content">
            ...
            <br />
            She has lived in Korea for twelve years and mastered the language
            from there. She has also worked as a cultural ambassador with UNESCO
            for ten years in Korea. Now, she is a full time tutor for Korean
            language and prepare her students for TOPIK certification exam.
          </div>
        </div>
        {/* footer */}
